    ...
    return (
        <div className='fixed top-[20%] right-0 z-40'>
            ...
            <div data-aos="zoom-in" data-aos-delay="1050" className='p-2 pb-0 hidden md:flex fixed bottom-0 left-5 xl:left-10 w-10 items-center justify-center text-colorsecondary'>
                <ul className=''>
                    <li className=''><a className='text-xl hover:text-neon hover-neon transtition duration-200 ease-in relative top-0 hover:-top-[5px]' href="https://github.com/Sujanban" target="_blank"><FiGithub className='m-4' /></a></li>
                    <li className=''><a className='text-xl hover:text-neon hover-neon transtition duration-200 ease-in relative top-0 hover:-top-[5px]' href="https://www.instagram.com/sujanban1/" target="_blank"><FiInstagram className='m-4' /></a></li>
