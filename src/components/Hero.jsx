        ...
        <main id='home' className='bg-bgmain h-[100vh]'>
            <div className='h-[100%] max-w-[1000px] m-auto flex flex-col items-start justify-center' data-aos="fade-up">
                <div className='max-w-[1000px] p-[25px] sm:p-[50px] md:p-[10%] lg:p-[50px] xl:p-[0px] m-auto'>
                    ...
                    <p data-aos="fade-up" data-aos-delay="850" className=' text-colorsecondary text-sm md:text-lg lg:text-xl'>I’m a Web Developer specializing in building the web with the JavaScript ecosystem.</p>
                    <li data-aos="fade-up" data-aos-delay="950" className='list-none my-12'><a className='text-sm md:text-base transtition duration-200 ease-in p-4 hover:bg-green-hover bg-green-hover border border-neon rounded text-neon' href='mailto:bansujan@gmail.com'>Lets have a talk!</a></li>
                </div>
            </div>
