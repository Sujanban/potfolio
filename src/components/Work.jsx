          ...
          <div className="py-8 sm:grid sm:grid-cols-[1fr_5fr] gap-2">
            ...
            <div className="flex sm:flex sm:flex-col items-center mb-4">
              {workData.map((job, index) => (
                <li
                  key={index}
                  className={`list-none mb-1 sm:w-full transtition duration-200 ease-in w-full p-4 text-sm ${selected === index ? "text-neon bg-slate-700" : "hover:text-neon hover-neon hover:bg-slate-700"
